...
class MediaRenderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        GLES20.glBindTexture(MediaSurface.GL_TEXTURE_EXTERNAL_OES, mSurface.getTextureName());
